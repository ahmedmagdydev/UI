jQuery(document).ready(function($) {
	var article 	= $(".center-article"),
		...
		options 	=  {cursorcolor : "#b6b6b6",railalign: "left",horizrailenabled: false,cursorborder:0},
		notif		= $(".notifications");
	...
	// };
 	...
 	$('.ui-accordion-content').css('height'	, '500px').niceScroll({cursorcolor : "#b6b6b6",railalign: "left",horizrailenabled: false,cursorborder:0});
